...
var style_IntercambiosLocales_5 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
    ...
    var labelText = ""; 
    var value = feature.get("Intercam");
    ...
    if (value >= 1.000000 && value <= 23.000000) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 44.000000 && value <= 69.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 8.0 + size, points: 6,
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 69.000000 && value <= 81.000000) {
            style = [ new ol.style.Style({
        image: new ol.style.RegularShape({radius: 8.0 + size, points: 6,
