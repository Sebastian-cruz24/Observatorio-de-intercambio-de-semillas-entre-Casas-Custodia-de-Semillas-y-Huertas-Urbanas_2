...
map.getView().fit([-8270136.240136, 504790.693340, -8266562.421718, 507319.528630], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Intercambio Casas Custodia y Huertas Urbanas</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (159 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Geovisor enfocado en el monitoreo y seguimiento de los procesos de intercambio de semillas criollas entre las Casas Custodias de Semillas y las Huertas Urbanas';
            }
